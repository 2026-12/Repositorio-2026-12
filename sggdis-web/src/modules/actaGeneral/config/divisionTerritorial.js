// Catálogo oficial de la división territorial de Costa Rica (7 provincias,
// 82 cantones y sus distritos), usado por el Apartado I del Acta General
// para el mismo patrón de selects en cascada que Dirección Regional / Área
// Rectora en el módulo de Guía de Inspección: al elegir una provincia se
// habilita el cantón, y al elegir el cantón se habilita el distrito.
export const PROVINCIAS_CATALOGO = [
  {
    nombre: 'San José',
    cantones: [
      ...
      { nombre: 'Puriscal', distritos: ['Santiago', 'Mercedes Sur', 'Barbacoas', 'Grifo Alto', 'San Rafael', 'Candelaria', 'Desamparaditos', 'San Antonio', 'Chires'] },
      { nombre: 'Tarrazú', distritos: ['San Marcos', 'San Lorenzo', 'San Carlos'] },
      { nombre: 'Aserrí', distritos: ['Aserrí', 'Tarbaca', 'Vuelta de Jorco', 'San Gabriel', 'La Legua', 'Monterrey', 'Salitrillos'] },
      ...
      { nombre: 'Vázquez de Coronado', distritos: ['San Isidro', 'San Rafael', 'Dulce Nombre de Jesús', 'Patalillo', 'Cascajal'] },
      { nombre: 'Acosta', distritos: ['San Ignacio', 'Guaitil', 'Palmichal', 'Cangrejal', 'Sabanillas'] },
      ...
      { nombre: 'Turrubares', distritos: ['San Pablo', 'San Pedro', 'San Juan de Mata', 'San Luis', 'Carara'] },
      { nombre: 'Dota', distritos: ['Santa María', 'Jardín', 'Copey'] },
      { nombre: 'Curridabat', distritos: ['Curridabat', 'Granadilla', 'Sánchez', 'Tirrases'] },
      { nombre: 'Pérez Zeledón', distritos: ['San Isidro de El General', 'General', 'Daniel Flores', 'Rivas', 'San Pedro', 'Platanares', 'Pejibaye', 'Cajón', 'Barú', 'Río Nuevo', 'Páramo', 'La Amistad'] },
      { nombre: 'León Cortés Castro', distritos: ['San Pablo', 'San Andrés', 'Llano Bonito', 'San Isidro', 'Santa Cruz', 'San Antonio'] },
    ],
  },
  {
    nombre: 'Alajuela',
    cantones: [
      { nombre: 'Alajuela', distritos: ['Alajuela', 'San José', 'Carrizal', 'San Antonio', 'Guácima', 'San Isidro', 'Sabanilla', 'San Rafael', 'Río Segundo', 'Desamparados', 'Turrúcares', 'Tambor', 'La Garita', 'Sarapiquí'] },
      { nombre: 'San Ramón', distritos: ['San Ramón', 'Santiago', 'San Juan', 'Piedades Norte', 'Piedades Sur', 'San Rafael', 'San Isidro', 'Ángeles', 'Alfaro', 'Volio', 'Concepción', 'Zapotal', 'San Isidro de Peñas Blancas', 'San Lorenzo'] },
      ...
      { nombre: 'Naranjo', distritos: ['Naranjo', 'San Miguel', 'San José', 'Cirrí Sur', 'San Jerónimo', 'San Juan', 'Rosario', 'Palmitos'] },
      ...
      { nombre: 'Zarcero', distritos: ['Zarcero', 'Laguna', 'Tapesco', 'Guadalupe', 'Palmira', 'Zapote', 'Brisas'] },
      { nombre: 'Valverde Vega', distritos: ['Sarchí Norte', 'Sarchí Sur', 'Toro Amarillo', 'San Pedro', 'Rodríguez'] },
      { nombre: 'Upala', distritos: ['Upala', 'Aguas Claras', 'San José o Pizote', 'Bijagua', 'Delicias', 'Dos Ríos', 'Yolillal', 'Canalete'] },
      { nombre: 'Los Chiles', distritos: ['Los Chiles', 'Caño Negro', 'El Amparo', 'San Jorge'] },
      { nombre: 'Guatuso', distritos: ['San Rafael', 'Buenavista', 'Cote', 'Katira'] },
      { nombre: 'Río Cuarto', distritos: ['Río Cuarto', 'Santa Isabel', 'Santa Rita'] },
    ],
  },
  {
    nombre: 'Cartago',
    cantones: [
      { nombre: 'Cartago', distritos: ['Oriental', 'Occidental', 'Carmen', 'San Nicolás', 'Aguacaliente (San Francisco)', 'Guadalupe (Arenilla)', 'Corralillo', 'Tierra Blanca', 'Dulce Nombre', 'Llano Grande', 'Quebradilla'] },
  ...
  },
  {
    ...
    cantones: [
      ...
      { nombre: 'Sarapiquí', distritos: ['Puerto Viejo', 'La Virgen', 'Horquetas', 'Llanuras del Gaspar', 'Cureña'] },
    ],
  },
  {
    nombre: 'Guanacaste',
    cantones: [
      ...
      { nombre: 'Santa Cruz', distritos: ['Santa Cruz', 'Bolsón', '27 de Abril', 'Tempate', 'Cartagena', 'Cuajiniquil', 'Diriá', 'Cabo Velas', 'Tamarindo'] },
      ...
      { nombre: 'Hojancha', distritos: ['Hojancha', 'Monte Romo', 'Puerto Carrillo', 'Huacas'] },
    ],
  },
  {
    nombre: 'Puntarenas',
    cantones: [
      { nombre: 'Puntarenas', distritos: ['Puntarenas', 'Pitahaya', 'Chomes', 'Lepanto', 'Paquera', 'Manzanillo', 'Guacimal', 'Barranca', 'Isla del Coco', 'Cóbano', 'Chacarita', 'Chira', 'Acapulco', 'El Roble', 'Arancibia'] },
      ...
      { nombre: 'Golfito', distritos: ['Golfito', 'Guaycará', 'Pavón'] },
      { nombre: 'Coto Brus', distritos: ['San Vito', 'Sabalito', 'Aguabuena', 'Limoncito', 'Pittier', 'Gutiérrez Braun'] },
      { nombre: 'Parrita', distritos: ['Parrita'] },
      { nombre: 'Corredores', distritos: ['Corredor', 'La Cuesta', 'Paso Canoas', 'Laurel'] },
      { nombre: 'Garabito', distritos: ['Jacó', 'Tárcoles'] },
      // Cantón 83 (2021): antes era el noveno distrito del cantón de Puntarenas.
      { nombre: 'Monteverde', distritos: ['Monteverde'] },
      // Cantón 84 (2022): antes era el segundo distrito del cantón de Golfito.
      { nombre: 'Puerto Jiménez', distritos: ['Puerto Jiménez'] },
    ],
  },
  {
    nombre: 'Limón',
    cantones: [
      ...
      { nombre: 'Pococí', distritos: ['Guápiles', 'Jiménez', 'La Rita', 'Roxana', 'Cariari', 'Colorado', 'La Colonia'] },
      { nombre: 'Siquirres', distritos: ['Siquirres', 'Pacuarito', 'Florida', 'Germania', 'El Cairo', 'Alegría'] },
      { nombre: 'Talamanca', distritos: ['Bratsi', 'Sixaola', 'Cahuita', 'Telire'] },
      { nombre: 'Matina', distritos: ['Matina', 'Batán', 'Carrandí'] },
