  ...
  if (pantallaActual === 'inicio') {
    return (
      <PantallaInicio
        ...
        // marcadores; falta conectarlos a una funcionalidad real.
        onHistorial={() => {
          console.log(
